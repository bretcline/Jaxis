...
{
    public partial class PourControl : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void timer1_Tick( object sender, EventArgs e )
        {
            ...
            pbEmpty.Height = (int)m_CurrentHeight - ( m_Count * m_Increment );
        ...
        public GlassTypes GlassType
        {
            set
            {
                ...
                switch( m_GlassType )
                {
                    ...
                    {
                        m_Increment = 4;
                        pbType.Image = Properties.Resources.Beer_full;
                        m_StartHeight = 326;
                        m_EndHeight = 0;
                        break;
                    }
                    ...
                    {
                        m_Increment = 2;
                        pbType.Image = Properties.Resources.Wine_full;
                        m_StartHeight = 204;
                        m_EndHeight = 82;
                        break;
                    }
                    ...
                    {
                        m_Increment = 1;
                        pbType.Image = Properties.Resources.Mixed_full;
                        m_StartHeight = 208;
                        m_EndHeight = 155;
                        break;
                    }
                }
                pbEmpty.Height = m_StartHeight;
                pbEmpty.BringToFront( );
            }
