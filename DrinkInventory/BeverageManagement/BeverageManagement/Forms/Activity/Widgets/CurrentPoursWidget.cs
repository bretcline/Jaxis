...
{
    public partial class CurrentPoursWidget : QueueingWidget<CalcPour>, IActivityControl
    {
        ...
        protected override void ProcessItem(CalcPour _item)
        {
            Log.Time( "CurrentPourWidget::ProcessItem()", LogType.Debug, false, () =>
            {
                ...
                //var proc = m_Database.GetPourPoint(_item.PourID);
                ...
                //                                PourTime = reader.GetDateTime(2),
                //                                TagID = reader.GetGuid(3),
                //                                TagNumber = reader.GetString(4),
                //                                UPCName = reader.GetString(5),
                ...
                //    {
                //        var loc =
                //            BLManagerFactory.Get().ManageLocations().GetStorageLocations().Where(
                //                l => l.LocationID == _item.LocationID).FirstOrDefault();
                //        var pourPoint = new PourPoint
                //                            {
                //                                Volume = _item.Volume,
                //                                Category = "Unknown",
                ...
                //                                TagID = _item.TagID,
                //                                TagNumber =
                //                                    BLManagerFactory.Get().ManageTags().GetTagNumber(_item.TagID),
                //                                UPCName = "Unknown",
                //                                Location = (null != loc) ? loc.Name : "Unknown",
                //                                Units = BLManagerFactory.Get().GetDefaultSizeType().Abbreviation
                //                            };
                //        AddPourPoint(pourPoint);
                //    }
