    ...
    public partial class BeverageMonitorDB : IQuerySurface
    {
        ...
        void Init()
        {
        	...
        	if(DataProvider.Schema.Tables.Count == 0)
			{
            	...
            	ActivityLogsSchema.Columns.Add(new DatabaseColumn("ActivityTypeID", ActivityLogsSchema)
												{
													IsPrimaryKey = false,
													DataType = DbType.Int32,
													IsNullable = false,
            	...
            	MovesSchema.Columns.Add(new DatabaseColumn("Quantitiy", MovesSchema)
												{
													IsPrimaryKey = false,
													DataType = DbType.Int32,
													IsNullable = false,
            	...
            	rptInventorySchema.Columns.Add(new DatabaseColumn("TotalBottleCost", rptInventorySchema)
												{
													IsPrimaryKey = false,
													DataType = DbType.Double,
													IsNullable = true,
            	...
            	rptInventorySchema.Columns.Add(new DatabaseColumn("TotalVolumeCost", rptInventorySchema)
												{
													IsPrimaryKey = false,
													DataType = DbType.Double,
													IsNullable = true,
            	...
            	UPCsSchema.Columns.Add(new DatabaseColumn("UnitPrice", UPCsSchema)
												{
													IsPrimaryKey = false,
													DataType = DbType.Currency,
													IsNullable = true,
            	...
            	UPCsSchema.Columns.Add(new DatabaseColumn("StandardPriceID", UPCsSchema)
												{
													IsPrimaryKey = false,
													DataType = DbType.Guid,
													IsNullable = true,
            	...
            	vwParLevelIssuesSchema.Columns.Add(new DatabaseColumn("Over/Under", vwParLevelIssuesSchema)
												{
													IsPrimaryKey = false,
													DataType = DbType.AnsiString,
													IsNullable = true,
            	...
            	vwUPCItemsSchema.Columns.Add(new DatabaseColumn("UnitPrice", vwUPCItemsSchema)
												{
													IsPrimaryKey = false,
													DataType = DbType.Currency,
													IsNullable = true,
