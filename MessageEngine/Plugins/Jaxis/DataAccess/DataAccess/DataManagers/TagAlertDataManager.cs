...
namespace Jaxis.Inventory.Data
{
    ...
    public class POSTicketItemViewManager : DataManager<IPOSTicketItemView, vwPOSTicketItem>, IPOSTicketItemViewManager, IDataManager
    {
        #region IDataManager<IPOSTicketItem> Members


        public IQueryable<IPOSTicketItemView> GetAll()
        {
            return vwPOSTicketItem.All();
        }

        public IPOSTicketItemView Get(Guid ID)
        {
            return vwPOSTicketItem.GetByID(ID);
        }
