...
namespace Jaxis.Inventory.Data
{
    public class InventoryItemBLManager : BLOnlyManager<IBLInventoryItem, BLInventoryItem>, IInventoryItemBLManager
    {
        ...
        {
            _Item.UserSessionID = BLManagerFactory.Get().UserSession.SessionID;
        ...
        public IBLInventoryItem Create( IBLTag _Item )
        {
            ...
            item.Cost = _Item.UPC.UnitCost.HasValue ? _Item.UPC.UnitCost.Value : 0;
            item.UserSessionID = BLManagerFactory.Get().UserSession.SessionID;
            rc.Inventory = item;
        ...
        public override bool Save( IBLInventoryItem item )
        {
            ...
            if( null != BLItem )
            {
                ...
                {
                    BLItem.Inventory.UserSessionID = BLManagerFactory.Get().UserSession.SessionID;
