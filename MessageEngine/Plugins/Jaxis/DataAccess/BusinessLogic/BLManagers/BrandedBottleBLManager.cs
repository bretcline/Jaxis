...
namespace Jaxis.Inventory.Data
{
    public class BrandedBottleBLManager : BLOnlyManager<IBLBrandedBottle, BLBrandedBottle>, IBrandedBottleBLManager
    {
        ...
        public bool SaveBrandedBottles( IEnumerable<IBLBrandedBottle> _bottles )
        {
            ...
            {
                // NOTE: We're not going to use the nozzle in the BLBrandedBottle class anymore since it creates a new standard nozzle record
                // every time you brand a bottle where the UPC has a specificaly set up nozzle size, instead of directly setting the tag's nozzle to the UPC's nozzle
