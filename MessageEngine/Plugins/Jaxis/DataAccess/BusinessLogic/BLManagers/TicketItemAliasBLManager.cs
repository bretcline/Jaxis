...
// ReSharper restore InconsistentNaming
    {
        private  TicketItemAliasHelper m_Helper = new TicketItemAliasHelper();

        public IEnumerable<string> GetUnknownAliases()
        {
            return m_Helper.GetUnknownAliases();
        }
    }


    // ReSharper disable InconsistentNaming
    public class TicketItemAliasViewBLManager : BLManager<ITicketItemAliasView, IBLTicketItemAliasView>, ITicketItemAliasViewBLManager
    // ReSharper restore InconsistentNaming
    {
        private TicketItemAliasHelper m_Helper = new TicketItemAliasHelper();
    ...
    internal class TicketItemAliasHelper
    {
