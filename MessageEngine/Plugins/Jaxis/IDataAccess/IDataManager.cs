...
namespace Jaxis.Inventory.Data
{
    ...
    public interface IPOSTicketItemViewManager : IDataManager<IPOSTicketItemView> { }
    ...
    public interface ITicketItemAliasViewManager : IDataManager<ITicketItemAliasView> { }
