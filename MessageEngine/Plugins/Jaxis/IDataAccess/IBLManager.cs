...
namespace Jaxis.Inventory.Data
{
    ...
    public interface IInventoryBLManager : IBLManager<IBLInventory> 
    {
        ...
        void UpdateInventoryCost(Guid _upcid, double _cost);
    }
    ...
    public interface IPourBLManager : IBLManager<IBLPour>
    {
        ...
        IEnumerable<IBLPour> GetByTicketItem(IBLPOSTicketItem _ticketItem);
    }
    public interface IPosPourBLManager : IBLManager<IBLPosPour>
    {
        IEnumerable<IUIPosPour> GetAfter(DateTime _beginDate);
        IEnumerable<IBLPosPour> GetBetween(DateTime _beginDate, DateTime _endDate, bool _unmatched);
    }
...
//        bool BrandBottle(string _tagID, string _upc, IBLStandardNozzle _nozzle);
    ...
    {
        IEnumerable<IBLUPCItem> GetUPCsByRootCategory(IBLCategory _rootCategory, IEnumerable<IBLUPCItem> _query);
        IEnumerable<IBLUPCItem> GetUPCsBySubCategory(IBLCategory _subCategory, IEnumerable<IBLUPCItem> _query);
        ...
        IEnumerable<IUIUPCItemShort> GetByManufacturerAndQuality(IBLIngredient _ingredient);
        IEnumerable<IUIUPCItemShort> GetByManufacturerNotQuality(IBLIngredient _ingredient);
        IEnumerable<IUIUPCItemShort> GetByCategoryAndQuality(IBLIngredient _ingredient);
        IEnumerable<IUIUPCItemShort> GetByCategoryNotQuality(IBLIngredient _ingredient);
        IEnumerable<IBLUPCItem> GetActiveWithDefaultCost();
    ...
    public interface IUserBLManager : IBLManager<IBLUser>
    {
        ...
        void LogOut(IBLUserSession _session);
    }
    ...
    public interface ITicketItemAliasViewBLManager : IBLManager<IBLTicketItemAliasView>
    {
        IEnumerable<string> GetUnknownAliases();
    }
    ...
    public interface IPOSTicketItemViewBLManager : IBLManager<IBLPOSTicketItemView>
    {
        IEnumerable<IBLPOSTicketItemView> GetBetween(DateTime _beginDate, DateTime _endDate, bool _unmatched);
        IBLRecipeItem GetRecipeByTicketItemAlias(string _description);
    }
