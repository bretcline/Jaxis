...
namespace IDENTEC
{
    namespace Readers
    {
        ...
        class iPortMCI
        {
            ...
            private System.Timers.Timer m_wake_up;
            /// <summary>
            ...
            public iPortMCI()
			{
                ...
                m_wake_up = new System.Timers.Timer();
                m_wake_up.Interval = 30000;             // time stays awake 30 seconds
                m_wake_up.AutoReset = false;
                ...
                m_TagError.Add(0x40, " Sequnec ID mismatch");
